        ...
        <div className="text-center p-12 border rounded-lg bg-muted/50">
          {teams?.length === 0 ? (
            <>
              ...
              <p className="text-muted-foreground mb-4">Create a new team or join an existing one.</p>
              <Button onClick={handleGoToCreateTeam}>
                <Plus className="mr-2 h-4 w-4" />
                Create Team
              </Button>
            ...
            <>
              ...
              <p className="text-muted-foreground mb-4">No teams match your search query.</p>
            ...
            <Card key={team.id}>
              ...
              <CardContent>
                ...
                <Input
                  ...
                  onChange={(e) => setTeamPassword(prev => ({ ...prev, [team.id]: e.target.value }))}
                />
              </CardContent>
              <CardFooter>
                <Button 
